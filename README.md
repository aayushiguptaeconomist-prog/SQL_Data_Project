...
```
![Most In-Demand Skills](project_sql/assets/most_in_demand_skills.png)
*Bar chart is used to identify the most demanded Data Analyst skills*
...
```
![Highest Paying Skills](project_sql/assets/highest_paying_skills.png)
*Lolipop chart is used to identify the highest paying Data Analyst skills*
...
```
![Optimal Skills](project_sql/assets/optimal_skills.png)
*Bubble chart is used to identify the highest paying and most demanded Data Analyst skills. Created 4 skill categories based on their demand and the salary generated by them. The size of the bubble is based on its demand.*
